export default {
  ...
  date: "2024-02-01",
  content: `
<p>Datasets and code can be found <a href="https://github.com/olehsekirkin/unlocking-insights-in-healthcare">here</a>.</p>
...
<p>This endeavor encompasses meticulous data preparation, patient segmentation through clustering algorithms, robust predictive modeling to forecast hospitalization charges and assess patient risk scores, geospatial analysis to visualize healthcare metrics across regions, and the development of an interactive dashboard for real-time monitoring. Here&rsquo;s a comprehensive overview of the journey and the methodologies employed.</p>
...
<p><strong>1.&nbsp;Data Architecture: laying the foundation</strong></p>
...
<body>
    <div class="clustering-container">
        <div class="text-content">
            <p>The results of the patient segmentation shed light on how clustering can help us categorize patient into distinct groups based on their health profiles. This segmentation aids in personalizing treatment strategies, improving healthcare resource allocation, and identifying patterns within the patient population. Let's dive into key findings:</p>
        </div>
...
<p>The scatterplot reveals clear separation among the clusters, with some overlap between clusters 1, 2 and 3, suggesting shared characteristics among these groups, while cluster 0 stands distinctly apart. This visualziation provides a high-level understanding of how the clusters are organized and the relationships between the patient groups.</p>
<p>These clusters uncovered distinct patient profiles that align with specific health and demographic characteristics, next is a breakdown of them:<br /><br /></p>
...
<p><strong>4. Predictive Modeling: forecasting charges and assessing risks</strong></p>
...
<p>For evaluation, the model's performance was evaluated using the Mean Squared Error (MSE) and&nbsp;R&sup2; score to measure its predictive accuracy. Feature importance were visualized to understand which factors had the most significant impact on hospitalization charges.</p>
...
<body>
    <div class="geo-container">
        <h2 class="section-header">5. Geospatial Analysis: mapping healthcare metrics across states</h2>
        ...
        <div class="visualization-card">
            ...
            <img class="visualization-image" src="https://i.ibb.co/qDp3gVz/ezgif-4-fc9927481d.gif" alt="Geospatial Analysis Animation" />
...
<p><strong>6. Cost Analysis: unveiling financial insights</strong></p>
...
<body>
    <div class="analysis-container">
        <div class="text-content">
            ...
            <p>&nbsp; &nbsp; 1) Distribution of Charges: as visualized in the histogram, the distribution of hospitalization charges is righ-skewed,&nbsp;with most patients incurring charges below $20,000, while a few cases exceed $50,000. This skew suggests that while most hospitalizations remain moderately priced, outliers drive up the average.<br />&nbsp; &nbsp; 2) Charges vs. Age:&nbsp;a scatterplot shows a general upward trend in hospitalization charges as patient age increases. Although the relationship between age and charges is not strictly linear, older patients tend to face higher costs, potentially due to the complexity of care required.<br /><strong>&nbsp; &nbsp; </strong>3)&nbsp;Charges by Hospital Tier: a boxplot&nbsp; reveals significant differences in charges across hospital tiers. Tier 1 hospitals, often the most advanced or specialized, show the highest median charges, with a wider range of costs compared to Tier 2 and Tier 3 hospitals. This suggests that hospital tier is a key determinant of the financial burden.<br />&nbsp; &nbsp; 4) Correlation Matrix:&nbsp;a heatmap visualizes the correlations between key variables. Charges are strongly negatively correlated with hospital_tier, meaning that higher-tier hospitals (with lower numerical values for tier) are associated with higher costs.</p>
        </div>
        ...
        <div class="visualizations-grid">
            ...
            <div class="visualization-card full-width">
                ...
                <img class="visualization-image" src="https://i.ibb.co/VmqSZ85/part64.webp" alt="Correlation Matrix Heatmap" style="max-width: 480px;" />
            </div>
        </div>
    </div>
</body>
...
<body>
    <div class="chronic-container">
        <h2 class="section-header">7. Chronic Disease Management: predicting complications</h2>
        ...
        <div class="visualizations-grid">
            ...
            <div class="visualization-card full-width">
                ...
                <img class="visualization-image" src="https://i.ibb.co/b5Yb08Z/part73.png" alt="Feature Importance" style="max-width: 480px;" />
        ...
        <div class="text-content">
            <p>The Top 10 Features driving the prediction of complications were identified. HBA1C and the Number of Major Surgeries were the most significant predictors, followed closely by charges, BMI, and children. This underscores the importance of monitoring glucose control (as measured by HBA1C) and surgical history when assessing complication risks in chronic disease patients.</p>
            
            <p>The trained model and its corresponding preprocessing pipeline were saved using <em>joblib</em>, enabling future deployment for real-time predictions. This model can now be utilized by healthcare providers to assess complication risks in chronic disease patients, offering tailored interventions to high-risk groups.</p>
        </div>
    </div>
</body>
</html>
...
<body>
    <div class="dashboard-container">
        ...
        <div class="visualization-card">
            ...
            <img class="visualization-image" src="https://i.ibb.co/P99QYWW/ezgif-4-97d17fb57b-1.gif" alt="Dashboard Demo" />
...
<p><strong>9. Scripts: structuring and querying the data</strong></p>
<p>Scripts can be found at&nbsp;my GitHub, link <a href="https://github.com/olehsekirkin/unlocking-insights-in-healthcare">here</a>, if you have any questions feel free to contact me on LinkedIn!</p>
